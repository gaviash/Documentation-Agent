...
1. **Explore project context** — check files, docs, recent commits (if commits there is)
...
- Check out the current project state first (files, docs, recent commits,if there is commits)
